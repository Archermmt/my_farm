...
public class Field : MonoBehaviour
{
    ...
    public void AddTile(Vector3 pos, RuleTile tile, FieldTag tag)
    {
        FieldGrid grid = FieldManager.Instance.GetGrid(pos);
        grid.AddTag(tag);
        tilemap_.SetTile(Vector3Int.FloorToInt(grid.position), tile);
